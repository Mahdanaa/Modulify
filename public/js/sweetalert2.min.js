...
(!(function (e, t) {
    ...
    We = (e, t) => {
      ...
      return o.length
        ? (-2 === (e += t) && (e = o.length - 1),
          ...
          o[e].focus(),
          !(navigator.userAgent.includes('Firefox') && o[e] instanceof HTMLIFrameElement))
  ...
  const $t = (e) =>
      (e instanceof Map ? Array.from(e) : Object.entries(e)).map(([e, t]) => [e, 'object' == typeof t ? $t(t) : t]),
  ...
  class Un {
    constructor(...t) {
      if (
        (n(this, Rn, Promise.resolve({ isConfirmed: !1, isDenied: !1, isDismissed: !0 })), 'undefined' == typeof window)
      )
        return;
      Fn = this;
